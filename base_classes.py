...
class DataBase(object):
    ...
    def data(self):
        return (self.__dict__['_'+col] for col in self.columns)
    pass
...
class DataTick(DataBase):
    ...
    def columns(cls):
        return (
            'symbol', 'price', 'volume','total_volume', 'timestamp', 'day_order',
            'ask_price', 'ask_size', 'bid_price', 'bid_size')
    
    def __init__(self, symbol, price, volume, total_volume, timestamp, day_order,
                 ask_price, ask_size, bid_price, bid_size):
        self._symbol = symbol
        self._price = price
        self._volume = volume
...
class DataBar(DataBase):
    ...
    def __init__(self, symbol, timestamp, period, first, last, high, low, average, volume,
                 total_volume):
        self._symbol = symbol
        self._timestamp = timestamp
        self._period = period
...
class FactorBase(object):
    ...
    def __eq__(self, other):
        return (self._symbol, self._interval) == (other._symbol, other._interval)
    pass
